...
function each_letter_in_binary(index, data) {
  ...
  $(datasplit).each(function(index,data2){
    ...
    if (index == datasplit.length-1){
      $('#output-quadrati').append("<hr style='clear:both; border:none'/>")
    }
  })
}
...
$(document).ready(function(){
  ...
  //$('#send-btn').click(printToOutput);
  window.addEventListener('push', update_width_and_height)
});